...
class VenueController: UIViewController, CLLocationManagerDelegate,UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    func initializeParameters(categoryId : String) {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        if let location = locations.first {
            ...
            ApiService.instance.callVenueByCategorySearchApi(categoryId: categoryId, lat: location.coordinate.latitude, lng: location.coordinate.longitude, completion: { (success) in
                if success {
